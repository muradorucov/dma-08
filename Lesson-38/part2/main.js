...
data.forEach(item => {
  tbody.innerHTML += `
    <tr>
      ...
      <td>${item.ticker}</td>
      <td>${item.value}</td>
      <td style="color:${item.change[0] === "-" ? "red" : "green"}">${item.change}</td>
    </tr>
  `
  // if (item.change[0] === "-") {
  //   tbody.innerHTML += `
  ...
  //   <td>${item.ticker}</td>
  //   <td>${item.value}</td>
  //   <td style="color:greenyellow">${item.change}</td>
  // </tr>
  // `
  // }
})
...
//   td2.innerText = item.ticker
//   td3.innerText = item.value
//   td4.innerText = item.change

//   if (item.change[0] === "-") {
//     td4.style.color = "red"
//   } else {
//     td4.style.color = "greenyellow"
//   }
//   tr.append(td1)
//   tr.append(td2)
//   tr.append(td3)
